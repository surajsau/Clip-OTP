...
class DefaultIndicatorController implements IndicatorController {
    ...
    public void initialize(int slideCount) {
        ...
        for (int i = 0; i < slideCount; i++) {
            ...
            dot.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.indicator_dot_blue));
    ...
    public void selectPosition(int index) {
        ...
        for (int i = 0; i < mSlideCount; i++) {
            int drawableId = (i == index) ? (R.drawable.indicator_dot_white) : (R.drawable.indicator_dot_blue);
